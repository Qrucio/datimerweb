                    ...
                    {tabs.map(tab => {
                        ...
                        return (
                            <button
                                ...
                                className={`relative flex items-center justify-center gap-1.5 md:gap-2 px-3 md:px-6 py-2 rounded-full text-xs font-semibold uppercase tracking-wider transition-colors z-10 ${isActive ? 'text-black' : 'text-white/40 hover:text-white'}`}
                            >
                                {isActive && (
                                    <motion.div
